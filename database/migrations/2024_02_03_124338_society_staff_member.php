...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('society_staff_member', function (Blueprint $table) {
            ...
            $table->string('duty_note')->nullable();
            $table->time('duty_start_time')->index();
            $table->time('duty_end_time')->index();
            $table->string('weekly_off_days')->nullable()->comment('1 - Mon, 2 - Tue, 3 - Wed, 4 - Thu, 5 - Fri, 6 - Sat, 7 - Sun')->index();
