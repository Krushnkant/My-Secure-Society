...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('payment_transaction', function (Blueprint $table) {
            ...
            $table->integer('payment_mode')->enum([1, 2])->comment('1 - Offline, 2 - Online')->index();
            $table->integer('payment_status')->enum([1, 2, 3, 4, 5, 6, 7])->default(1)->comment('1 - Paid, 2 - Failed, 3 - Due, 4 - Pending, 5 - In Hold, 6 - Refund, 7 - Cancelled')->index();
