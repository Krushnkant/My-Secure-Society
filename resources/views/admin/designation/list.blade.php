            ...
            $('#designationTable').DataTable({
                ...
                aoColumns: [{
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render: function(data, type, row) {
                            var is_edit = @json(getUserDesignation() == 1 || (getUserDesignation() != 1 && is_edit(1)));
                            if (is_edit) {
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render: function(data, type, row) {
                            var is_view = @json(getUserDesignation() == 1 || (getUserDesignation() != 1 && is_view(2)));
                            var is_edit = @json(getUserDesignation() == 1 || (getUserDesignation() != 1 && is_edit(1)));
                            var is_delete = @json(getUserDesignation() == 1 || (getUserDesignation() != 1 &&is_delete(1)));
