        ...
        <div style="font-family: 'Roboto', sans-serif; margin:20px; ">
            ...
            <div style="text-align: center; background-color: #fff; padding: 50px; min-width:650px; ">
                ...
                <div style="margin-bottom: 5px; font-size: 13px;">
                    {{ $data['message'] }} <br>
                <a href="{{ $data['message'] }}" style="background-color: #4CAF50; border: none;color: white;text-align: center; text-decoration: none;display: inline-block;font-size: 16px;padding:5px;margin: 4px 2px;cursor: pointer;">Reset password</a>
